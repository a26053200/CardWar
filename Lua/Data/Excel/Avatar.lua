...
Data.table = 
{
    ["Villager_B_Boy"] = {id = "Villager_B_Boy", name = "Villager", type = "", hudOffset = "0,110,0", scale = 1.2, animBorn = "DrawDagger", animIdle = "Attackstandy", animDead = "Death", animRun = "Run", animWin = "GangnamStyle", animHit = "Damage", prefabUrl = "Models/villarger_B_Boy/Prefabs/Villager_B_Boy.prefab"},
