-- CheckPoint 2020/4/17 0:04:07
local Data = {
    ["battle_1_1"] = {id = "battle_1_1", name = "研究院1", type = "", chapter = 0, section = 1, level = "pve_research_1_UH", layoutDistance = 10, layoutGridSize = 2, layoutPoints = "p1", layoutPrefabUrl = "Prefabs/Layouts/Layout_Battle_01.prefab", light = "1", cameraDistance = 11, cameraAngle = "30,135,0", cameraOffset = "0,0,0"},
