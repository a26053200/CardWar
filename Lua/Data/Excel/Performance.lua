-- Performance 2020/4/22 0:55:16
local Data = {}
Data.table = {    ["micro_dragon_atk"] = {id = "micro_dragon_atk", name = "普通攻击", type = "Standard", gridSelect = "Current", accountType = "Single", animInfo = "micro_dragon_atk", duration = 0, interval = 0, delay = 0, times = 1, param = "", shake = ""},
