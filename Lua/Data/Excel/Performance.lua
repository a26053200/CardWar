...
Data.table = 
{
    ...
    ["Villager_B_Boy_skill1"] = {id = "Villager_B_Boy_skill1", name = "技能1", type = "Standard", gridSelect = "Col", accountType = "Single", animInfo = "Villager_B_Boy_skill1", duration = 0, interval = 0, delay = 0, times = 1, param = "", shake = ""},
    ["Villager_B_Boy_skill2"] = {id = "Villager_B_Boy_skill2", name = "技能2", type = "Standard", gridSelect = "Row", accountType = "Single", animInfo = "Villager_B_Boy_skill2", duration = 0, interval = 0, delay = 0, times = 1, param = "", shake = ""},
    ["Villager_B_Boy_skill3"] = {id = "Villager_B_Boy_skill3", name = "技能3", type = "Standard", gridSelect = "All", accountType = "Single", animInfo = "Villager_B_Boy_skill3", duration = 0, interval = 0, delay = 0, times = 1, param = "", shake = ""},
