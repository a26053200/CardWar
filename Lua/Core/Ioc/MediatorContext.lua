...
function MediatorContext:Launch()
	...
	self.binder:Bind(require("Game.Modules.CheckPoint.View.CheckPointReportMdr")):To(ViewConfig.CheckPointReport.name)
	self.binder:Bind(require("Game.Modules.Common.View.TransitionMdr")):To(ViewConfig.Transition.name)
